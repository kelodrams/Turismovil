...
public class ConexionMysql {
 ...
 public JSONObject recibir(String url, String Metodo, List<NameValuePair> parametros){
		try{
			if(Metodo == "get"){
				//listado
				...
				HttpEntity entidadResp = httpresponse.getEntity();
				is = entidadResp.getContent();
			}
		}
		...
		try{
			...
			Log.e("Buffer Error", "Error converting results " + error.toString());
		}
